...
//     // const [temAbout, setTempAbout] = useState()
//     // const [tempType, setTempType] = useState()
//     // const [tempPrivatePublic, setTempPrivatePublic] = useState()
...
//             {updateForm ? (
//                 <>
//                     <button type='button' disabled={disable} onSubmit={()=>handleUpdate()} >Update Group</button>
//                     <button onClick={() => history.push('/groups')}>Cancel</button>
//                 </>
//             ) : (

//                 <>
//                     <button type='submit' disabled={disable} onSubmit={()=>handleSubmit()}>Create Group</button>
